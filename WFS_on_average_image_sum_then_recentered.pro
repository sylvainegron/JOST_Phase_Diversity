FUNCTION WFS_on_average_image_sum_then_recentered, ConfigFiles,dirdatas, file_bg_Focuss,file_bg_Defocuss,file_image_Focuss,file_image_Defocuss,defoc_array_microns,Correction_myopes
